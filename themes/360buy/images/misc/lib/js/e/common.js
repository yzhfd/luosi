...
function openSpeDiv(message, goods_id, parent) 
{
  ...
  {
      newDiv.innerHTML += '<hr style="color: #EBEBED; height:1px;"><h4 style="text-align:left; background:#ffffff; margin-left:15px;margin-bottom:8px">' +  message[spec]['name'] + '</h4>';
      ...
      if (message[spec]['attr_type'] == 1)
      {
        for (var val_arr = 0; val_arr < message[spec]['values'].length; val_arr++)
        {
          if (val_arr == 0)
          {
            newDiv.innerHTML += "<div style='margin-bottom:8px;'><input style='margin-left:15px;' type='radio' name='spec_" + message[spec]['attr_id'] + "' value='" + message[spec]['values'][val_arr]['id'] + "' id='spec_value_" + message[spec]['values'][val_arr]['id'] + "' checked /><font color=#555555>" + message[spec]['values'][val_arr]['label'] + '</font> [' + message[spec]['values'][val_arr]['format_price'] + ']</font><br /></div>';      
          }
          else
          {
            newDiv.innerHTML += "<div style='margin-bottom:8px;'><input style='margin-left:15px;' type='radio' name='spec_" + message[spec]['attr_id'] + "' value='" + message[spec]['values'][val_arr]['id'] + "' id='spec_value_" + message[spec]['values'][val_arr]['id'] + "' /><font color=#555555>" + message[spec]['values'][val_arr]['label'] + '</font> [' + message[spec]['values'][val_arr]['format_price'] + ']</font><br /></div>';      
          }
        } 
  ...
  newDiv.innerHTML += "<br /><br /><center><input type='button' value=' 确定 ' class='' onclick='javascript:submit_div(" + goods_id + "," + parent + ")'/>&nbsp;&nbsp;<input type='button' value=' 取消 ' class='' onclick='javascript:cancel_div()'/><br /><br /></center>";
