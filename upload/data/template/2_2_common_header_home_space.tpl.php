...
0
|| checktplrefresh('./template/yeei_dream1/common/header.htm', './template/default/common/header_common.htm', 1350390658, '2', './data/template/2_2_common_header_home_space.tpl.php', './template/yeei_dream1', 'common/header_home_space')
|| checktplrefresh('./template/yeei_dream1/common/header.htm', './template/yeei_dream1/common/pubsearchform.htm', 1350390658, '2', './data/template/2_2_common_header_home_space.tpl.php', './template/yeei_dream1', 'common/header_home_space')
;?>
