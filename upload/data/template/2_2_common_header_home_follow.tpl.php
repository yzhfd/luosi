...
0
|| checktplrefresh('./template/yeei_dream1/common/header.htm', './template/default/common/header_common.htm', 1351284788, '2', './data/template/2_2_common_header_home_follow.tpl.php', './template/yeei_dream1', 'common/header_home_follow')
|| checktplrefresh('./template/yeei_dream1/common/header.htm', './template/yeei_dream1/common/pubsearchform.htm', 1351284788, '2', './data/template/2_2_common_header_home_follow.tpl.php', './template/yeei_dream1', 'common/header_home_follow')
;?>
