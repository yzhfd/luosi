...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1351414174, '2', './data/template/2_2_member_login.tpl.php', './template/yeei_dream1', 'member/login')
