...
0
|| checktplrefresh('./template/default/portal/index.htm', './template/yeei_dream1/common/header.htm', 1350480846, 'diy', './data/template/2_diy_portal_index.tpl.php', './template/yeei_dream1', 'portal/index')
|| checktplrefresh('./template/default/portal/index.htm', './template/yeei_dream1/common/footer.htm', 1350480846, 'diy', './data/template/2_diy_portal_index.tpl.php', './template/yeei_dream1', 'portal/index')
|| checktplrefresh('./template/default/portal/index.htm', './template/default/common/header_common.htm', 1350480846, 'diy', './data/template/2_diy_portal_index.tpl.php', './template/yeei_dream1', 'portal/index')
|| checktplrefresh('./template/default/portal/index.htm', './template/yeei_dream1/common/pubsearchform.htm', 1350480846, 'diy', './data/template/2_diy_portal_index.tpl.php', './template/yeei_dream1', 'portal/index')
;?>
...
<script src="misc.php?mod=diyhelp&action=get&type=index&diy=<?php echo $_GET['diy'];?>&r=<?php echo random(4); ?>" type="text/javascript" type="text/javascript"></script><?php echo adshow("footerbanner/wp a_f/1");?><?php echo adshow("footerbanner/wp a_f/2");?><?php echo adshow("footerbanner/wp a_f/3");?><?php echo adshow("float/a_fl/1");?><?php echo adshow("float/a_fr/2");?><?php echo adshow("couplebanner/a_fl a_cb/1");?><?php echo adshow("couplebanner/a_fr a_cb/2");?><?php echo adshow("cornerbanner/a_cn");?><?php if(!empty($_G['setting']['pluginhooks']['global_footer'])) echo $_G['setting']['pluginhooks']['global_footer'];?>
    </div>
        </div>
</div></div>
