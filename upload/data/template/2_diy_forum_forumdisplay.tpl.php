...
0
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/yeei_dream1/common/header.htm', 1350479679, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/yeei_dream1', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1350479679, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/yeei_dream1', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1350479679, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/yeei_dream1', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/yeei_dream1/forum/forumdisplay_list.htm', 1350479679, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/yeei_dream1', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1350479679, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/yeei_dream1', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/yeei_dream1/common/footer.htm', 1350479679, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/yeei_dream1', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/common/header_common.htm', 1350479679, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/yeei_dream1', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/yeei_dream1/common/pubsearchform.htm', 1350479679, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/yeei_dream1', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1350479679, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/yeei_dream1', 'forum/forumdisplay')
|| checktplrefresh('./template/default/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1350479679, 'diy', './data/template/2_diy_forum_forumdisplay.tpl.php', './template/yeei_dream1', 'forum/forumdisplay')
;?>
...
<?php } ?>
<th class="<?php echo $thread['folder'];?>" style="padding-left:8px;">
...
</div><?php echo adshow("footerbanner/wp a_f/1");?><?php echo adshow("footerbanner/wp a_f/2");?><?php echo adshow("footerbanner/wp a_f/3");?><?php echo adshow("float/a_fl/1");?><?php echo adshow("float/a_fr/2");?><?php echo adshow("couplebanner/a_fl a_cb/1");?><?php echo adshow("couplebanner/a_fr a_cb/2");?><?php echo adshow("cornerbanner/a_cn");?><?php if(!empty($_G['setting']['pluginhooks']['global_footer'])) echo $_G['setting']['pluginhooks']['global_footer'];?>
    </div>
        </div>
</div></div>
