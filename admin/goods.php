...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    $goods_spec = !empty($_POST['goods_spec']) ? $_POST['goods_spec'] : '';
    $goods_addinfo = !empty($_POST['goods_addinfo']) ? $_POST['goods_addinfo'] : '';
    $goods_cad = !empty($_POST['goods_cad']) ? $_POST['goods_cad'] : '';
    ...
    if ($is_insert)
    {
        if ($code == '')
        {
            $sql = "INSERT INTO " . $ecs->table('goods') . " (goods_name, goods_name_style, goods_sn, " .
                    "cat_id, brand_id, shop_price, market_price,goods_spec,goods_addinfo,goods_cad, is_promote, promote_price, " .
                ...
                "VALUES ('$_POST[goods_name]', '$goods_name_style', '$goods_sn', '$catgory_id', " .
                    "'$brand_id', '$shop_price', '$market_price', '$goods_spec','$goods_addinfo','$goods_cad','$is_promote','$promote_price', ".
