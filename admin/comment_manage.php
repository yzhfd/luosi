...
function get_comment_list()
{
    ...
    {
         //888
        $sql = ($row['comment_type'] == 1) ? "SELECT title FROM ".$GLOBALS['ecs']->table('article'). " WHERE article_id='$row[id_value]'" : "SELECT goods_name FROM " .$GLOBALS['ecs']->table('goods'). " WHERE goods_id='$row[id_value]'";
