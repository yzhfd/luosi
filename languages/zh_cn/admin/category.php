...
$_LANG['warn_catimg'] = '你已经上传过图片。再次上传时将覆盖原图片';
$_LANG['warn_catvideo'] = '你已经上传过视频。再次上传时将覆盖原视频';

$_LANG['drop_cat_img'] = '删除分类图片';
$_LANG['confirm_drop_cat_img'] = '你确认删除该分类图片吗？';
$_LANG['drop_cat_img_success'] = '删除分类图片成功';
$_LANG['cat_edit_lnk'] = '重新编辑该分类';

$_LANG['drop_use_img'] = '删除安装图片';
$_LANG['confirm_drop_use_img'] = '你确认删除该安装图片吗？';
$_LANG['drop_use_img_success'] = '删除安装图片成功';

$_LANG['drop_cat_video'] = '删除分类视频';
$_LANG['confirm_drop_cat_video'] = '你确认删除该分类视频吗？';
$_LANG['drop_cat_video_success'] = '删除分类视频成功';
