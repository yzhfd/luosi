...
<div class="main-div">
  ...
  <table width="100%" id="general-table">
      ...
      <tr>
        ...
        <tr>
        <td class="label"><?php echo $this->_var['lang']['is_goods']; ?>:</td>
        <td>
          <input type="radio" name="is_goods" value="1" <?php if ($this->_var['cat_info']['is_goods'] != 0): ?> checked="true"<?php endif; ?>/> <?php echo $this->_var['lang']['yes']; ?>
          <input type="radio" name="is_goods" value="0" <?php if ($this->_var['cat_info']['is_goods'] == 0): ?> checked="true"<?php endif; ?> /> <?php echo $this->_var['lang']['no']; ?>
        </td>
      </tr>
      <tr>
...
?>
      ...
      <tr>
       ...
       <tr>
    <td class="label"><?php if ($this->_var['cat_info']['cat_img'] != ""): ?><a href="javascript:showNotice('warn_catimg');" title="<?php echo $this->_var['lang']['form_notice']; ?>">
        <img src="images/warning_small.gif" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>"></a><?php endif; ?><?php echo $this->_var['lang']['cat_img']; ?></td>
    <td><input type="file" name="cat_img"  size="45"><?php if ($this->_var['cat_info']['cat_img'] != ""): ?><input type="button" value="<?php echo $this->_var['lang']['drop_cat_img']; ?>" onclick="if (confirm('<?php echo $this->_var['lang']['confirm_drop_cat_img']; ?>'))location.href='category.php?act=drop_cat_img&id=<?php echo $this->_var['cat_info']['cat_id']; ?>'">
    <br /><span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?> id="warn_catimg"><?php echo $this->_var['lang']['warn_catimg']; ?></span><?php endif; ?>
    </td>
  </tr>
    <tr>
    <td class="label"><?php if ($this->_var['cat_info']['use_img'] != ""): ?><a href="javascript:showNotice('warn_catimg');" title="<?php echo $this->_var['lang']['form_notice']; ?>">
        <img src="images/warning_small.gif" width="16" height="16" border="0" alt="<?php echo $this->_var['lang']['form_notice']; ?>"></a><?php endif; ?><?php echo $this->_var['lang']['use_img']; ?></td>
    <td><input type="file" name="use_img"  size="45"><?php if ($this->_var['cat_info']['use_img'] != ""): ?><input type="button" value="<?php echo $this->_var['lang']['drop_use_img']; ?>" onclick="if (confirm('<?php echo $this->_var['lang']['confirm_drop_use_img']; ?>'))location.href='category.php?act=drop_use_img&id=<?php echo $this->_var['cat_info']['cat_id']; ?>'">
    <br /><span class="notice-span" <?php if ($this->_var['help_open']): ?>style="display:block" <?php else: ?> style="display:none" <?php endif; ?> id="warn_useimg"><?php echo $this->_var['lang']['warn_useimg']; ?></span><?php endif; ?>
    </td>
  </tr>
   <tr>
    <td class="label"><?php echo $this->_var['lang']['cat_video']; ?></td>
    ...
    <input type="hidden" name="old_catimg" value="<?php echo $this->_var['cat_info']['cat_img']; ?>">
    <input type="hidden" name="old_useimg" value="<?php echo $this->_var['cat_info']['use_img']; ?>">
