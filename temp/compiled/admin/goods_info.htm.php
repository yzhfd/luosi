...
?>
          ...
          <!--鍟嗗搧浼樻儬浠锋牸 end -->
           <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_goods_spec']; ?></td>
            <td><input type="text" name="goods_spec" value="<?php echo $this->_var['goods']['goods_spec']; ?>" size="20" />
            </td>
          </tr>
           <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_goods_addinfo']; ?></td>
            <td><input type="text" name="goods_addinfo" value="<?php echo $this->_var['goods']['goods_addinfo']; ?>" size="20" />
            </td>
          </tr>
           <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_goods_cad']; ?></td>
            <td><input type="text" name="goods_cad" value="<?php echo $this->_var['goods']['goods_cad']; ?>" size="20" />
            </td>
          </tr>
          <tr>
