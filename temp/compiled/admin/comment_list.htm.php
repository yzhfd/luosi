...
?>
  <tr>
    ...
    <td><?php if ($this->_var['comment']['comment_type'] == 2): ?>提问-<script>get_comment_type(<?php echo $this->_var['comment']['ip_address']; ?>);</script><?php else: ?><?php echo $this->_var['lang']['type'][$this->_var['comment']['comment_type']]; ?><?php endif; ?></td>
    <!--//888-->
    <td><a href="../<?php if ($this->_var['comment']['comment_type'] == '1'): ?>article<?php else: ?>goods<?php endif; ?>.php?id=<?php echo $this->_var['comment']['id_value']; ?>" target="_blank"><?php echo $this->_var['comment']['title']; ?></td>
