...
<div id="ECS_VOTE" style=" padding-left:6px; padding-top:8px">
...
?>
    ...
    foreach ($_from AS $this->_var['title']):
?>
          <?php $_from = $this->_var['title']['options']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item_0_85684600_1363162479');if (count($_from)):
    foreach ($_from AS $this->_var['item_0_85684600_1363162479']):
?>
            <?php if ($this->_var['title']['can_multi'] == 0): ?>
            <input type="checkbox" name="option_id" value="<?php echo $this->_var['item_0_85684600_1363162479']['option_id']; ?>" />
            <?php echo $this->_var['item_0_85684600_1363162479']['option_name']; ?> (<?php echo $this->_var['item_0_85684600_1363162479']['percent']; ?>%)<br />
            <?php else: ?>
            <input type="radio" name="option_id" value="<?php echo $this->_var['item_0_85684600_1363162479']['option_id']; ?>" />
            <?php echo $this->_var['item_0_85684600_1363162479']['option_name']; ?> (<?php echo $this->_var['item_0_85684600_1363162479']['percent']; ?>%)<br />
            <?php endif; ?>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
     ...
     <input type="submit" name="submit" value="<?php echo $this->_var['lang']['submit']; ?>" />
     <input type="reset" value="<?php echo $this->_var['lang']['reset']; ?>" />
     </form>
  </div>
